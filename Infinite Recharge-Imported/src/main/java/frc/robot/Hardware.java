...
public class Hardware {
    ...
    public static final WPI_VictorSPX shooterSlaveMotor = 
        new WPI_VictorSPX(Constants.SHOOTER_SLAVE_MOTOR);
    ...
    // Climber Motors
    public static final WPI_VictorSPX wenchMasterMotor = 
        new WPI_VictorSPX(Constants.WENCH_MASTER_MOTOR);
