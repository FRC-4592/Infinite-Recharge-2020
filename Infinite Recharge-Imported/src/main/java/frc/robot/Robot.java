...
public class Robot extends TimedRobot {
    ...
    private IntakeWheels intakeWheels = new IntakeWheels(Hardware.intakeMotor, Hardware.shifter3);
    ...
    //private Climber climber = new Climber(Hardware.wenchMasterMotor, Hardware.wenchSlaveMotor, Hardware.shifter2);
    ...
    public void robotInit() {
        ...
        SSLooper.addLoopable(limelight);
